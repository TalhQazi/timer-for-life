...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (result.success) {
        Alert.alert('Success', result.message, [{ text: 'OK', onPress: () => router.replace('/home') }]);
      } else {
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.form}>
            ...
            <TouchableOpacity style={[styles.loginButton, isLoading && styles.disabledButton]} onPress={handleLogin} disabled={isLoading}>
              <MaterialCommunityIcons name="login" size={24} color="#FFFFFF" style={styles.buttonIcon} />
            ...
            <View style={styles.privacyRow}>
              <Text style={styles.privacyText}>To login you are accpecting our </Text>
...
const styles = StyleSheet.create({
  ...
  eyeIcon: { padding: 4 },
  loginButton: { backgroundColor: COLORS.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, borderRadius: 12, marginBottom: 24, elevation: 3, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 },
  ...
  registerContainer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 24 },
  registerText: { color: COLORS.textSecondary, fontSize: 16 },
  registerLink: { color: COLORS.primary, fontSize: 16, fontWeight: '600' },
  skipButton: { backgroundColor: 'transparent', borderWidth: 1, borderColor: COLORS.textSecondary, paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  skipButtonText: { color: COLORS.textSecondary, fontSize: 16, fontWeight: '600' },
  privacyRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 12, flexWrap: 'wrap' },
